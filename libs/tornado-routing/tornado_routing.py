    ...
    def route(self, rule, methods=['GET'], kwargs=None, name=None):
        ...
        def decorator(func, *args, **kwargs):
            ...
            for method in methods:
                self.handler_map.setdefault(full_class_name, {})[
                    method] = (rule, func_name)
                app_routing_log.info("register %s %s to %s.%s" % (
                    method, rule, full_class_name, func_name))
